...
public class GenerateUniversity : GenerateLargeBuildingBase {
    ...
    public GenerateUniversity(Section section, int buildingId, EnumDirection rotation, TileData building)
